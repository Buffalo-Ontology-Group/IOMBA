 ...
 * [iomba.yml](iomba.yml)
     * Determines how your purl.obolibrary.org/obo/iomba/ redirects will be handled
     ...
     * Paste in the contents of [iomba.yml](iomba.yml)
 ...
 * [iomba.md](iomba.md)
     ...
     * Paste in the contents of [iomba.md](iomba.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
